...
//     @Req() req: AuthRequest,
//   ) {
//     return this.blogsService.updateNotificationPreferences(
//       id,
//       req.user.userId,
//       body,
//     );
...
export class BlogsController {
  ...
  // --- AUTHENTICATED USER BLOG MANAGEMENT ---
  ...
  /**
   * SUCCESS: This single route now handles ALL blog updates
   * (Title, Slug, Description, Cover/Profile Images, etc.)
   */
  @UseGuards(JwtAuthGuard)
  @Patch('me')
  async updateMyBlog(@Req() req: AuthRequest, @Body() dto: UpdateBlogDto) {
